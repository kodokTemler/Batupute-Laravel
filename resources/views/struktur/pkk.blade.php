    ...
    <div class="heading">
      <div class="container">
        <div class="row d-flex justify-content-center text-center">
          <div class="col-lg-8">
            <h1>Struktur Kepergurusan PKK</h1>
            <p class="mb-0">
              Halaman ini menyajikan informasi lengkap struktur kepengurusan PKK yang berada di Desa Batupute.
            </p>
          </div>
        </div>
      </div>
                ...
                <div class="portfolio-details-slider swiper init-swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide">
                            <a href="{{asset('profile/img/struktur/pkk.png')}}" class="glightbox" >
                                <img src="{{asset('profile/img/struktur/pkk.png')}}" class="img-fluid" alt="" />
                            </a>
                        </div>
                    </div>
                </div>
