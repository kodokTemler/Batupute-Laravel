        ...
        <div class="heading">
          <div class="container">
            <div class="row d-flex justify-content-center text-center">
              <div class="col-lg-8">
                <h1>Transparansi Bumdes dan Kopdes MP</h1>
                <p class="mb-0">
                  Halaman ini menyajikan informasi lengkap mengenai transparnsi bumdes dan kopdes mp yang ada di Desa Batupute.
                </p>
              </div>
            </div>
          </div>
        ...
        <nav class="breadcrumbs">
          <div class="container">
            <ol>
              ...
              <li class="current">Bumdes dan Kopdes MP</li>
            </ol>
          </div>
        </nav>
      </div>
        ...
        <div class="container section-title" data-aos="fade-up">
          <div class="row justify-content-center mt-5">
            <div class="col-12 col-md-10">
              <h2>Transparansi Bumdes dan Kopdes MP</h2>
              <p>
                Berikut adalah daftar transparansi bumdes dan kopdes mp yang dapat diakses oleh masyarakat.
              </p>
            </div>
                ...
                <div class="card card-custom p-4 mb-3">
                  <div class="row align-items-center g-4">
                    ...
                    <div class="col-12 col-md-8">
                      <h5 class="fw-bold text-start text-md-start">{{ $bumdes->judul}}</h5>
                      <div class="d-flex align-items-center text-secondary mb-1">
                        <i class="bi bi-calendar fs-5 me-2"></i>
                        <span>{{ $bumdes->tahun }}</span>
                      </div>
                      <div class="d-flex align-items-center text-secondary">
                        <i class="bi bi-clock fs-5 me-2"></i>
                        <span>{{ $bumdes->created_at->locale('id')->translatedFormat('l, d/m/Y') }}</span>
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                      <div class="d-flex flex-md-column flex-wrap justify-content-md-end justify-content-center gap-2">
                        <a href="javascript:void(0);" onclick="openModal('{{ $bumdes->file_bukti }}')" 
                        ...
                        <a href="{{ route('transparansi-bumdes.download', $bumdes->file_bukti) }}" 
            ...
            <div class="container">
              <div class="d-flex justify-content-center">
                ...
                <ul class="pagination justify-content-center">
                  <!-- Previous Page Link -->
                  @if ($transparansiBumdes->onFirstPage())
                    <li class="page-item disabled">
                      <a href="#" class="page-link"><i class="bi bi-chevron-left"></i></a>
                    </li>
                  @else
                    <li class="page-item">
                      <a href="{{ $transparansiBumdes->previousPageUrl() }}" class="page-link"><i class="bi bi-chevron-left"></i></a>
                    </li>
                  @endif
          
                  <!-- Page Number Links -->
                  @php
                    $totalPages = $transparansiBumdes->lastPage();
                    $currentPage = $transparansiBumdes->currentPage();
                    $pagesToShow = 3;
                  @endphp
                  ...
                  @if ($totalPages <= $pagesToShow)
                    @foreach(range(1, $totalPages) as $i)
                      <li class="page-item {{ $i == $currentPage ? 'active' : '' }}">
                        <a href="{{ $transparansiBumdes->url($i) }}" class="page-link">{{ $i }}</a>
                      </li>
                    @endforeach
                  @else
                    <!-- Always Show First Page -->
                    <li class="page-item {{ 1 == $currentPage ? 'active' : '' }}">
                      <a href="{{ $transparansiBumdes->url(1) }}" class="page-link">1</a>
                    </li>
                    ...
                    <li class="page-item {{ $totalPages == $currentPage ? 'active' : '' }}">
                      <a href="{{ $transparansiBumdes->url($totalPages) }}" class="page-link">{{ $totalPages }}</a>
                    </li>
                  @endif
          
                  <!-- Next Page Link -->
                  @if ($transparansiBumdes->hasMorePages())
                    <li class="page-item">
                      <a href="{{ $transparansiBumdes->nextPageUrl() }}" class="page-link"><i class="bi bi-chevron-right"></i></a>
                    </li>
                  @else
                    <li class="page-item disabled">
...
<script>
    ...
    document.getElementById('fileFrame').src = `/transparansi/transparansi-bumdes/${filename}`;
    modal.show();
  }
</script>
